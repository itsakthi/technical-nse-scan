 ...
 constructor(req, res) {
  ...
  const optionPriceInterval = setInterval(async () => {  
    let options = {
      ...
      'path': '/products/dynaContent/common/productsSymbolMapping.jsp?instrumentType=OPTSTK&symbol=' + symbol + '&expiryDate=28-11-2019&optionType=CE&strikePrice=&dateRange=&fromDate=' + reqDate + '&toDate=' + reqDate + '&segmentLink=9&symbolCount=',
      'method': 'GET',
      'headers': {
          'Accept': '*/*',
    ...
    https.get(options, function (http_res) {
      ...
      http_res.on("end", function () {
        ...
        if (CEDetails.length <= 3) {
          ...
          options.path = '/products/dynaContent/common/productsSymbolMapping.jsp?instrumentType=OPTSTK&symbol=' + symbol + '&expiryDate=28-11-2019&optionType=PE&strikePrice=&dateRange=&fromDate=' + reqDate + '&toDate=' + reqDate + '&segmentLink=9&symbolCount=',
          https.get(options, function (http_res) {
